<?php
define('PENCI_SOLEDAD_VERSION', '8.4.2');
/**
...
if (!function_exists('penci_load_scripts')) {
	...
	function penci_load_scripts() {
		...
		wp_register_script('penci-slick', get_template_directory_uri() . '/js/slick.min.js', array(), PENCI_SOLEDAD_VERSION, true);
		...
		if (get_theme_mod('penci_single_font_changer')) {
			wp_enqueue_script('jquery.range-min.js', get_template_directory_uri() . '/js/jquery.range-min.js', array(), PENCI_SOLEDAD_VERSION, true);
		}
		...
		wp_register_script('penci_bgajax_more_terms', get_template_directory_uri() . '/js/more-terms-bg.js', array('jquery'), PENCI_SOLEDAD_VERSION, true);
		wp_localize_script(
		...
		wp_register_script('penci_bgajax_more_terms_scroll', get_template_directory_uri() . '/js/more-terms-scroll-bg.js', array('jquery'), PENCI_SOLEDAD_VERSION, true);
		wp_localize_script(
		...
		wp_register_script('penci_ajax_filter_terms_bg', get_template_directory_uri() . '/js/ajax-filter-terms.js', array('jquery'), PENCI_SOLEDAD_VERSION, true);
		wp_localize_script(
		...
		wp_register_script('penci-animate-headline', get_template_directory_uri() . '/js/heading-animates.js', array('jquery', 'elementor-frontend-modules'), PENCI_SOLEDAD_VERSION);
		wp_register_script('penci-float-banner', get_template_directory_uri() . '/js/float-banner.js', array('jquery'), PENCI_SOLEDAD_VERSION, true);

		wp_register_style('jquery.toast', get_template_directory_uri() . '/css/jquery.toast.min.css', array(), PENCI_SOLEDAD_VERSION);
		wp_register_script('jquery.toast', get_template_directory_uri() . '/js/jquery.toast.min.js', array(), PENCI_SOLEDAD_VERSION, true);

		if (get_theme_mod('penci_enable_reading_bar')) {
			wp_enqueue_script('penci-header-scroll', get_template_directory_uri() . '/js/header-scroll.js', array('jquery'), PENCI_SOLEDAD_VERSION, true);
		}
	}
}
...
// Customizer
require trailingslashit(get_template_directory()) . 'inc/customizer/default.php';
require trailingslashit(get_template_directory()) . 'inc/customizer/sanitizing.php';
if (penci_loads_cm()) {
	include trailingslashit(get_template_directory()) . 'inc/customizer/framework/bootstrap.php';
} else {
	penci_show_cs_notice();
}
require trailingslashit(get_template_directory()) . 'inc/customizer/generate-css-file.php';
require trailingslashit(get_template_directory()) . 'inc/customizer/style.php';
require trailingslashit(get_template_directory()) . 'inc/customizer/customizer-tools/autoload.php';
require trailingslashit(get_template_directory()) . 'inc/darkmode.php';
require trailingslashit(get_template_directory()) . 'inc/customizer/style-page-header-title.php';
require trailingslashit(get_template_directory()) . 'inc/customizer/style-page-header-transparent.php';
require trailingslashit(get_template_directory()) . 'inc/fonts/fonts.php';

// Modules
require trailingslashit(get_template_directory()) . 'inc/detect_mobile.php';
require trailingslashit(get_template_directory()) . 'inc/theme-updates.php';
require trailingslashit(get_template_directory()) . 'inc/modules/penci-render.php';
require trailingslashit(get_template_directory()) . 'inc/modules/penci-walker.php';
require trailingslashit(get_template_directory()) . 'inc/modules/svg-social.php';
require trailingslashit(get_template_directory()) . 'inc/template-function.php';
require trailingslashit(get_template_directory()) . 'inc/videos-playlist.php';
require trailingslashit(get_template_directory()) . 'inc/weather.php';
require trailingslashit(get_template_directory()) . 'inc/login-popup.php';
require trailingslashit(get_template_directory()) . 'inc/popup.php';
require trailingslashit(get_template_directory()) . 'inc/age-verify.php';
require trailingslashit(get_template_directory()) . 'inc/social-counter/social-counter.php';
...
require trailingslashit(get_template_directory()) . 'inc/widgets/social_widget.php';
require trailingslashit(get_template_directory()) . 'inc/widgets/about_widget.php';
require trailingslashit(get_template_directory()) . 'inc/widgets/lastest_post_widget.php';
require trailingslashit(get_template_directory()) . 'inc/widgets/popular_post_widget.php';
require trailingslashit(get_template_directory()) . 'inc/widgets/block_heading.php';
require trailingslashit(get_template_directory()) . 'inc/widgets/facebook_widget.php';
require trailingslashit(get_template_directory()) . 'inc/widgets/related_post_widget.php';
require trailingslashit(get_template_directory()) . 'inc/widgets/posts_slider_widget.php';
require trailingslashit(get_template_directory()) . 'inc/widgets/quote_widget.php';
require trailingslashit(get_template_directory()) . 'inc/widgets/pinterest_widget.php';
require trailingslashit(get_template_directory()) . 'inc/widgets/patreon.php';
require trailingslashit(get_template_directory()) . 'inc/widgets/buymeacoffee.php';
require trailingslashit(get_template_directory()) . 'inc/widgets/list_banner.php';
require trailingslashit(get_template_directory()) . 'inc/widgets/login_register_widgets.php';
require trailingslashit(get_template_directory()) . 'inc/widgets/video_playlist.php';
require trailingslashit(get_template_directory()) . 'inc/widgets/social_counter.php';
require trailingslashit(get_template_directory()) . 'inc/widgets/advanced_categories.php';
require trailingslashit(get_template_directory()) . 'inc/widgets/authors_list.php';
require trailingslashit(get_template_directory()) . 'inc/widgets/posts_tabs.php';
require trailingslashit(get_template_directory()) . 'inc/widgets/search_box.php';
require trailingslashit(get_template_directory()) . 'inc/widgets/snapchat.php';
require trailingslashit(get_template_directory()) . 'inc/widgets/tiktok_embed.php';
require trailingslashit(get_template_directory()) . 'inc/widgets/comments.php';
require trailingslashit(get_template_directory()) . 'inc/widgets-ajax.php';
...
// Like post
require trailingslashit(get_template_directory()) . 'inc/like_post/post-like.php';

// Meta box
require trailingslashit(get_template_directory()) . 'inc/meta-box/meta-box.php';
require trailingslashit(get_template_directory()) . 'inc/meta-box/categories-meta-box.php';
require trailingslashit(get_template_directory()) . 'inc/custom-sidebar.php';
	...
	function penci_register_required_plugins() {
		...
		$plugins = array(
			...
			array(
				...
				'required' => false, // If false, the plugin is only 'recommended' instead of required
				'version' => '3.4', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
				'force_activation' => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
				'force_deactivation' => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
				'external_url' => '', // If set, overrides default API URL and points to an external URL
			),
...
if (!function_exists('penci_custom_markup_for_gallery') && !get_theme_mod('penci_post_disable_gallery')) {
	...
	function penci_custom_markup_for_gallery($string, $attr) {
		...
		if ($type == 'thumbnail-slider'):
			$output .= '<div class="penci-slick-carousel pcthumb-s-msl pcthumb-m-' . $slider_id . '">';
		endif;
		...
		if ($type == 'thumbnail-slider') {
			$output .= '<div data-cols="7" class="pcthumb-s-csl pcgl-thumb-slider penci-slick-carousel pcthumb-c-' . $slider_id . '">' . $thumbnail_html . '</div>';
			$output .= '<div class="penci-slick-carousel-top-nav"><div class="pcslick-nav-area"><div class="pcslick-nav"><button type="button" class="slick-prev"><i class="penciicon-left-chevron"></i></button><button type="button" class="slick-next"><i class="penciicon-right-chevron"></i></button></div><div class="slider-num"><span class="current">1</span>' . __(' of ', 'soledad') . '<span class="total">' . count($posts) . '</span></div></div></div>';
		}
...
if (!function_exists('penci_soledad_social_share')) {
	function penci_soledad_social_share($pos = '') {
		...
		if (is_single() || is_page() && get_theme_mod('penci_post_share_disbtnplus')) {
...
require trailingslashit(get_template_directory()) . 'inc/excerpt.php';
require trailingslashit(get_template_directory()) . 'inc/instagram/instagram.php';
require trailingslashit(get_template_directory()) . 'inc/twitter/dashpage.php';
require trailingslashit(get_template_directory()) . 'inc/global-js.php';
require trailingslashit(get_template_directory()) . 'soledad_vc.php';
...
require get_template_directory() . '/inc/comment_ratings.php';
