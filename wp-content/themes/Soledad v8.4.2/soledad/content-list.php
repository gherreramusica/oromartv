    ...
    <article id="post-<?php the_ID(); ?>" class="item hentry">
		...
		<?php elseif ( has_post_thumbnail() ) : ?>
            <div class="thumbnail">
				...
				<?php if ( ! get_theme_mod( 'penci_disable_lazyload_layout' ) ) { ?>
                    <a class="penci-image-holder penci-lazy<?php echo penci_class_lightbox_enable() . $class_load; ?>"
						<?php
						if ( get_theme_mod( 'penci_grid_nocrop_list' ) ) :
				...
				<?php } else { ?>
                    <a class="penci-image-holder<?php echo penci_class_lightbox_enable() . $class_load; ?>"
                       style="background-image: url('<?php echo penci_get_featured_image_size( get_the_ID(), $thumbnail_load ); ?>');
					   <?php
					   if ( get_theme_mod( 'penci_grid_nocrop_list' ) ) :
						   echo 'padding-bottom: ' . penci_get_featured_image_ratio( get_the_ID(), 'penci-masonry-thumb' ) . '%;';
					   endif;
					   ?>
                               "
                       href="<?php penci_permalink_fix(); ?>"
