            ...
            <div class="nav-menu-wrapper">
                ...
                <form role="search" method="get" class="search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
                    <label>
                        ...
                        <input type="search" class="search-field" placeholder="<?php echo esc_attr_x( 'Busca en Oromar', 'placeholder' ); ?>" value="<?php echo get_search_query(); ?>" name="s" />
                    </label>
                ...
                <div class="section-menu">
                    <div class="sectionA">
                        ...
                        <div><a href="<?php echo site_url('/deportesoromar') ?>">DEPORTES OROMAR</a></div>
                    </div>
                    <div class="sectionB">
                ...
                <div class="section-menu">
                    ...
                    <div class="section-menu">
                        <div class="sectionC">
                            ...
                            <div><a href="<?php echo site_url('/reportes') ?>">PAUTA CON NOSOTROS</a></div>
                            <div><a href="<?php echo site_url('/reportes') ?>">TRABAJA CON NOSOTROS</a></div>                      
